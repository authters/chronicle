...
class ConnectionPublisher implements TransactionalPublisher
{
    ...
    public function create(Stream $stream): void
    {
        ...
        } catch (QueryPublisherError $exception) {
    ...
    protected function addStreamToStreamsTable(Stream $stream): void
    {
        ...
        if (!$result) {
            throw new QueryPublisherError("Unable to insert data in event stream table");
        }
    }
